...
export const createOrEditGoals = (data: Partial<WorkoutGoal> | null, method: 'POST' | 'PUT') =>
  pipe(
    Effect.try({
      try: () =>
        JSON.stringify({
...
export const createOrEditWorkouts = (data: Partial<Workout> | null, method: 'POST' | 'PUT') =>
  pipe(
    Effect.try({
      try: () =>
        JSON.stringify({
...
export const createOrEditWorkoutTypes = (data: { name?: string } | null, method: 'POST' | 'PUT') =>
  pipe(
    Effect.try({
      try: () =>
        JSON.stringify({
